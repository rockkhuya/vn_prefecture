# coding: utf-8
require "vn_prefecture/mapping"
require "vn_prefecture/zip_mapping"
...
module VnPrefecture
  ...
  class Prefecture
    ...
    # @example
    #   # コード/名前から都道府県クラスを生成
    #   VnPrefecture::Prefecture.build(1, '北海道', 'Hokkaido')
    #
    ...
    # @example
    #   # 都道府県コードから検索
    #   VnPrefecture::Prefecture.find(1)
    #   VnPrefecture::Prefecture.find(code: 1)
    #
    #   # 都道府県名から検索
    #   VnPrefecture::Prefecture.find(name: '北海道')
    #
    #   # 英語表記の都道府県名から検索
    #   VnPrefecture::Prefecture.find(name: 'Hokkaido')
    #   VnPrefecture::Prefecture.find(name: 'hokkaido')
    #
    ...
    # @return [VnPrefecture::Prefecture] 都道府県が見つかった場合は都道府県クラス
